...
The sound effects in `assets/audio/` are selected and renamed from these Kenney packs:

- [Interface Sounds](https://kenney.nl/assets/interface-sounds)
- [Impact Sounds](https://kenney.nl/assets/impact-sounds)

Both packs were created by Kenney and released under the
[Creative Commons Zero 1.0 Universal license](https://creativecommons.org/publicdomain/zero/1.0/).
Attribution is not required; it is included here to keep the project provenance clear.
...
| `slime-hit-hard.ogg` | `impactSoft_heavy_002.ogg` | Impact Sounds |
| `block-break.ogg` | `impactMining_001.ogg` | Impact Sounds |
